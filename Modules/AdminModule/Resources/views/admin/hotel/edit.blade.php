                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.hotels.update', $hotel->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="whatsapp_number" class="form-control" value="{{ $hotel->whatsapp_number }}" placeholder="e.g. 201234567890">
                        </div>
                        <div class="row">
                        ...
                        <div class="mb-3">
                            ...
                            @if($hotel->image)
                                <img src="{{ asset('storage/app/public/'.$hotel->image) }}" class="mt-2" width="100">
                            @endif
                        </div>
                        <div class="mb-3">

            ...
            <div class="banner-wrapper justify-content-between bg__img wow animate__fadeInDown"
                ...
                <div class="banner-content">
                    ...
                    <div class="app--btns d-flex flex-wrap">
                        <div class="dropdown">
                            <a href="#" class="cmn--btn h-50" data-bs-toggle="dropdown">{{translate('Download User App')}}</a>
            ...
            <div class="basic-info-wrapper wow animate__fadeInUp">
                <div class="basic-info-item">
                    <img
                        ...
                        alt="">
                    <div class="content">
                        <h2 class="h5 fw-bold mb-3">{{ $businessStatistics?->value && $businessStatistics?->value['total_download']['count'] ? $businessStatistics?->value['total_download']['count'] : "1M+" }}</h2>
                        <p>{{ $businessStatistics?->value && $businessStatistics?->value['total_download']['content'] ? translate($businessStatistics?->value['total_download']['content']) : translate("download") }}</p>
                    </div>
                </div>
                <div class="basic-info-item">
                    <img
                        ...
                        alt="">
                    <div class="content">
                        <h2 class="h5 fw-bold mb-3">{{ $businessStatistics?->value && $businessStatistics?->value['complete_ride']['count'] ? $businessStatistics?->value['complete_ride']['count'] : "1M+" }}</h2>
                        <p>{{ $businessStatistics?->value && $businessStatistics?->value['complete_ride']['content'] ? translate($businessStatistics?->value['complete_ride']['content']) : translate("Complete Ride") }}</p>
                    </div>
                </div>
                <div class="basic-info-item">
                    <img
                        ...
                        alt="">
                    <div class="content">
                        <h2 class="h5 fw-bold mb-3">{{ $businessStatistics?->value && $businessStatistics?->value['happy_customer']['count'] ? $businessStatistics?->value['happy_customer']['count'] : "1M+" }}</h2>
                        <p>{{ $businessStatistics?->value && $businessStatistics?->value['happy_customer']['content'] ? translate($businessStatistics?->value['happy_customer']['content']) : translate("Happy Customer") }}</p>
                    </div>
                </div>
                <div class="basic-info-item">
                    <img
                        ...
                        alt="">
                    <div class="content">
                        <h2 class="h5 fw-bold mb-3">{{ $businessStatistics?->value && $businessStatistics?->value['support']['title'] ? $businessStatistics?->value['support']['title'] : "24/7 hr" }}</h2>
                        <p>{{ $businessStatistics?->value && $businessStatistics?->value['support']['content'] ? translate($businessStatistics?->value['support']['content']) : translate("Support") }}</p>
                    </div>
                </div>
            </div>
        </div>

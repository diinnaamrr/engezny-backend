<?php return array (
  ...
  '5MB_image_note' => 'ملاحظة صورة بحجم 5 ميجابايت',
  'APP_DEBUG' => 'تصحيح التطبيق',
  'APP_MODE' => 'وضع التطبيق',
  'APP_NAME' => 'اسم التطبيق',
  'APP_URL' => 'عنوان URL للتطبيق',
  'Add' => 'أضف',
  'Add_Driver_Level' => 'أضف مستوى السائق',
  ...
  'Business_Information' => 'معلومات تجارية',
  'Business_Pages' => 'صفحات الأعمال',
  'By default  it is set to 10 meters' => 'بشكل افتراضي يتم ضبطه على 10 أمتار',
  'By default  it is set to 5 kilometers' => 'بشكل افتراضي، تم ضبطه على 5 كيلومترات',
  'By turning the ‘Maintenance Mode’ ON  all your apps and user websites will be disabled temporarily' => 'من خلال تشغيل "وضع الصيانة" سيتم تعطيل جميع تطبيقاتك ومواقع المستخدم الخاصة بك مؤقتًا',
  'CSV' => 'CSV',
  ...
  'Customers can search for drivers within the radius (in kilometer) you have set here' => 'يمكن للعملاء البحث عن السائقين ضمن النطاق (بالكيلومتر) الذي حددته هنا',
  ...
  'Ex: Schwarzmüller' => 'على سبيل المثال: شوارزمولر',
  ...
  'driver_max_commission_limit' => 'الحد الأقصى لعمولة السائق',
  'Set the maximum commission amount a driver can owe before being blocked from receiving trips' => 'حدد أقصى مبلغ عمولة يمكن أن يدين به السائق قبل إيقافه عن استقبال الرحلات',
  ...
  'want_to_permanent_delete_this_driver?' => 'هل تريد حذف هذا السائق نهائياً؟',
  'want_to_permanent_delete_this_customer?' => 'هل تريد حذف هذا العميل نهائياً؟',
  'want_to_permanent_delete_this_vehicle?' => 'هل تريد حذف هذه العربية نهائياً؟',
  'want_to_permanent_delete_this_category?' => 'هل تريد حذف هذا التصنيف نهائياً؟',
  'want_to_permanent_delete_this_brand?' => 'هل تريد حذف هذه الماركة نهائياً؟',
  'want_to_permanent_delete_this_model?' => 'هل تريد حذف هذا الموديل نهائياً؟',
  ...
  'Minimum_Fare' => 'الحد الادني',
  'minimum_trip_fare' => 'الحد الادني',
  'set_the_minimum_trip_fare_for_the_ride' => 'إذا كانت أجرة الرحلة المحسوبة (الأجرة الأساسية + المسافة، وبعد نسبة الزيادة للمنطقة إن وُجدت) أقل من هذا المبلغ، يُحسب للعميل هذا الحد الأدنى. الضرائب وأجور الانتظار تُضاف بعد ذلك.',
  ...
  'Successfully sent OTP' => 'تم إرسال رمز التحقق (OTP) بنجاح',
  ...
  'Your registered vehicle is not approved or active. Please contact system admin  otherwise you do not found trip in this system.' => 'مركبتك غير معتمدة أو قيد انتظار الموافقة. تواصلي مع إدارة النظام.',
  ...
  'Your account is deleted successfully' => 'تم حذف حسابك بنجاح',
  ...
  'Wrong login credentials' => 'بيانات تسجيل الدخول خاطئة',
  ...
  'Resource expired' => 'انتهت صلاحية المورد',
  'Password reset successful' => 'تم إعادة تعيين كلمة المرور بنجاح',
  'Password changed successful' => 'تم تغيير كلمة المرور بنجاح',
  'Given password does not match with previous password' => 'كلمة المرور المدخلة لا تطابق كلمة المرور السابقة',
  'No changes found' => 'لم يتم العثور على أي تغييرات',
  'No data found' => 'لم يتم العثور على بيانات',
  'Invalid or missing data' => 'بيانات غير صالحة أو مفقودة',
  'User has been removed, please talk to the authority' => 'تم إزالة المستخدم، يرجى مراجعة الإدارة',
  'User not found' => 'المستخدم غير موجود',
  'Your account is under review' => 'حسابك قيد المراجعة',
  'User has been disabled, please talk to the authority' => 'تم تعطيل المستخدم، يرجى مراجعة الإدارة',
  'Your access has been denied' => 'تم رفض وصولك',
  'Retrieved data is not active' => 'البيانات المسترجعة غير نشطة',
  'Action failed' => 'فشلت العملية',
  'Already paid' => 'مدفوع بالفعل',
  'Successfully deleted information' => 'تم حذف المعلومات بنجاح',
  'Successfully restored' => 'تم الاستعادة بنجاح',
  'Your api hit limit exceeded, try after a minute.' => 'تجاوزت الحد المسموح به لطلبات API، يرجى المحاولة بعد دقيقة.',
  'Incorrect phone number or password, Please try again' => 'رقم الهاتف أو كلمة المرور غير صحيحة، يرجى المحاولة مرة أخرى',
  'Incorrect phone number, Please try again' => 'رقم الهاتف غير صحيح، يرجى المحاولة مرة أخرى',
  'No user found with that information' => 'لم يتم العثور على مستخدم بهذه المعلومات',
  'User account has been disabled, please talk to the admin.' => 'تم تعطيل حساب المستخدم، يرجى مراجعة المسؤول.',
  'Access denied' => 'تم رفض الوصول',
  'Customer does not exists' => 'العميل غير موجود',
  'Driver does not exists' => 'السائق غير موجود',
  'These credentials do not match our records.' => 'بيانات الاعتماد هذه لا تتطابق مع سجلاتنا.',
  'Too many login attempts. Please try again in :seconds seconds.' => 'محاولات تسجيل دخول كثيرة جداً. يرجى المحاولة مرة أخرى بعد :seconds ثانية.',
  'Your password has been reset!' => 'تم إعادة تعيين كلمة المرور الخاصة بك!',
  'We have emailed your password reset link!' => 'لقد أرسلنا بريداً إلكترونياً يحتوي على رابط إعادة تعيين كلمة المرور الخاصة بك!',
  'Please wait before retrying.' => 'يرجى الانتظار قبل المحاولة مرة أخرى.',
  'This password reset token is invalid.' => 'رمز إعادة تعيين كلمة المرور هذا غير صالح.',
  'We can\'t find a user with that email address.' => 'لا يمكننا العثور على مستخدم بعنوان البريد الإلكتروني هذا.',
  'Previous' => 'السابق',
  'Next' => 'التالي',
  ...
  'The email must be a valid email address.' => 'يجب أن يكون البريد الإلكتروني بريداً إلكترونياً صحيحاً.',
  'The password must be at least 8 characters.' => 'يجب أن تكون كلمة المرور 8 رموز على الأقل.',
);